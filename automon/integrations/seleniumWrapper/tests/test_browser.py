...
browser.set_webdriver_wrapper(
    ChromeWrapper().enable_defaults().enable_headless()
)
    ...
    if browser.is_ready():
        ...
        def test_add_cookie_from_url(self):
            if browser.get('https://8.8.8.8'):
                ...
                try:
                    self.assertTrue(browser.add_cookie_from_url('https://8.8.8.8'))
                except:
                    pass
        ...
        def test__url_filename(self):
            self.assertTrue(browser._url_filename('https://8.8.8.8'))
        ...
        def test_get(self):
            self.assertTrue(browser.get('https://8.8.8.8'))

        def test_get_page(self):
            self.assertTrue(browser.get_page('https://8.8.8.8'))
        ...
        def test_urlparse(self):
            self.assertTrue(browser.urlparse('https://8.8.8.8'))
